...
This folder contains foundational exercises and learning materials used to build the skills and knowledge needed for more advanced cybersecurity projects.

The items in this folder are small, concept-focused implementations created to build specific skills before scaling to larger projects. 
...
- Purpose: Build a strong understanding of encryption concepts and how to implement them using various methods. 

## Purpose 

- Practice core cybersecurity concepts with simple, easy to run scripts
- Reinforce theoretical knowledge with hands-on implementation
- Prepare for larger projects such as:
    - coming soon
...
The section in the `notes.md` file (found in the folder called "Cryptography-Basics") labeled as "AES Encryption" contains my notes obtained from following the GeeksforGeeks article [Advanced Encryption Standard (AES)](https://www.geeksforgeeks.org/computer-networks/advanced-encryption-standard-aes/). The specific matrices described in the notes were obtained directly from GeeksforGeeks.
